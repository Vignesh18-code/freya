  ...
  return (
    <main style={{ backgroundColor: '#070C1A', color: '#fff' }}>
      ...
      <section style={{ padding: '0 1.5rem 4rem' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', border: '1px solid rgba(201,168,76,0.25)', background: 'linear-gradient(95deg, rgba(201,168,76,0.12), rgba(201,168,76,0.05))', padding: '1.3rem' }}>
