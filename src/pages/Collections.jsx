  ...
  return (
    <main style={{ backgroundColor: '#001935', color: '#fff' }}>
      ...
      <section style={{ padding: '0 clamp(1rem, 4vw, 1.5rem) 3rem' }}>
        <div className="page-container" style={{ maxWidth: '1520px', margin: '0 auto', border: '1px solid rgba(201,168,76,0.25)', background: 'linear-gradient(95deg, rgba(201,168,76,0.12), rgba(201,168,76,0.05))', padding: 'clamp(1rem, 4vw, 1.3rem)' }}>
