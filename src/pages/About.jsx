...
const ABOUT_PARAGRAPHS = [
  ...
  'Today Freya Trading stands as a symbol of professionalism, integrity, and innovation in the precious metals industry. As we continue our journey, we remain dedicated to creating sustainable value, expanding our global footprint, and strengthening our position as a preferred partner in the international bullion market.',
...
function About() {
  return (
    <main style={{ color: '#fff', backgroundColor: '#001935' }}>
      ...
      <section className="page-container" style={{ maxWidth: '1520px', margin: '0 auto', padding: 'clamp(2rem, 5vw, 2.6rem) clamp(1rem, 4vw, 1.5rem)' }}>
        <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} style={{ margin: 0, fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(2rem, 6vw, 2.4rem)', fontWeight: 500, lineHeight: 1.15 }}>
          Freya Trading (HK) Ltd. – A Member of the SuGandh Group
        </motion.h2>
